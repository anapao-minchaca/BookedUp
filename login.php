...
<head>
    ...
    <!-- Title  -->
    <title>Booked Up - Los mejores libros | Sign Up</title>
...
<body>
    ...
    if(isset($_POST['submit'])){
        ...
        $No_tarjeta = mysqli_real_escape_string($enlace, $_POST['No_tarjeta']);
        $CVV = mysqli_real_escape_string($enlace, $_POST['CVV']);
        $Fecha_exp = mysqli_real_escape_string($enlace, $_POST['Fecha_exp']);
        $mail = mysqli_real_escape_string($enlace, $_POST['mail']);

        $sql = "INSERT INTO Cliente(Username, Contrasena, Nombres, Apellidos, Num_Ext, Num_Int, Colonia, Ciudad, Calle, CP, Estado, No_tarjeta, CVV, Fecha_exp, mail) VALUES ('$Username',          '$Contrasena', '$Nombres', '$Apellidos', '$Num_Ext', '$Num_Int', '$Colonia', '$Ciudad', '$Calle', '$CP', '$Estado', '$No_tarjeta', '$CVV', '$Fecha_exp', '$mail')";
                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="login.php" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="email" class="form-control" name="mail" placeholder="Email" value="" required>
                                    </div>
                                    <div class="col-12 mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <input type="text" class="form-control mb-3" name="Contrasena" placeholder="Contraseña" value="" required>
                                    </div>
                                    <p> Datos de método de pago </p>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" name="No_tarjeta" placeholder="Número de tarjeta" value="" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="password" class="form-control" name="CVV" placeholder="CVV" value="" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" name="Fecha_exp" placeholder="Fecha de Expiración (YYYY)" value="" required>
                                    </div>

                                </div>      
                                        <div class="cart-summary mt-0">
                                            <div class="cart-btn">
                                                <input type="submit" name="submit" value="Sign Up" class="btn amado-btn w-100">
                                            </div>

                                            <div class="cart-btn mt-5">
                                                <a href="login2.php" class="btn amado-btn w-100">Log In</a>
                                            </div>
                                        </div>
                                    </div>
                            </form>
